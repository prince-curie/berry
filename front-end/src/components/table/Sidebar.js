...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            />
            <div
                className={`h-screen fixed bg-gray-900 top-0 md:left-0 ${showSidebar} overflow-y-auto flex-row flex-nowrap overflow-hidden shadow-xl bg-white w-64 z-10 py-4 px-6 transition-all duration-300`}
            >
                        ...
                        <ul className="flex-col min-w-full flex list-none">
                            <li className="rounded-lg mb-4">
                                <NavLink
                                    to="/"
                                    exact
                                    className="flex items-center gap-4 text-sm text-gray-200 font-light px-4 py-3 rounded-lg"
                            ...
                            <li className="px-4 rounded-lg mb-2 text-gray-200">
                                <a
